...
class IdentifyRoutesTest {
    @Test
    fun testRoundTripIdentification() =
        testApplication {
            application { module() }
            ...
            val headerUuid = renderResponse.headers["X-Document-UUID"]
            ...
            assertEquals(headerUuid, result.documentId, "Identified UUID should match the render header")
        }

    @Test
    fun testUnknownPdfReturnsNullDocumentId() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testEmptyBodyReturnsBadRequest() =
        testApplication {
            application { module() }
