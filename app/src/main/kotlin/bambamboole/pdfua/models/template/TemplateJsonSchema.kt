...
object TemplateJsonSchema {
    ...
    private val definitionTsTypes =
        mapOf(
            "blockConfig" to "{ typography?: TypographyConfig; spacing?: SpacingConfig; " +
                "width?: string | null; align?: Align | null }",
    ...
    private fun definitions(): Map<String, PropertyDefinition> =
        linkedMapOf(
            ...
            "pageBackgroundType" to
                stringEnum(
                    "PageBackgroundType",
                    PageBackgroundType.entries.map { it.serializedName() },
                ),
