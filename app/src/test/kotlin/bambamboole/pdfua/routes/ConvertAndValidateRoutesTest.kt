...
class ConvertAndValidateRoutesTest {
    @Test
    fun testConvertAndValidateWithValidHTML() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testConvertAndValidateWithValidApiKey() =
        testApplication {
            environment {
    ...
    @Test
    fun testConvertAndValidateWithInvalidApiKey() =
        testApplication {
            environment {
                config = MapApplicationConfig("api.key" to "test-api-key")
            }
                ...
                client.post("/convert-and-validate") {
                    ...
                    setBody(
                        Json.encodeToString(
                            ...
                            ConvertRequest("<html><body>Test</body></html>"),
                        ),
                    )
                }
    ...
    @Test
    fun testConvertAndValidateWithoutApiKeyWhenAuthEnabled() =
        testApplication {
            environment {
                config = MapApplicationConfig("api.key" to "test-api-key")
            }
